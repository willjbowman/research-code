...
grain_text, gb_text = 'Grain', 'Grain\nboundary'
text_color = 'maroon'
grain_text_x, grain_text_y = 0.5e5, 1.05e5
gb_text_x, gb_text_y = 3e5, 0.9e5

legend_labels = ( '200$^\circ$C', '225$^\circ$C', '250$^\circ$C' ) # legend info
...
ax_lim = [ 4e5, 1.5e5 ] #subplot axis limits
...
def format_subplot( subplot_number ):
    axes_format() #format subplot axes
...
pl.legend( legend_labels, loc = legend_location, markerscale = 1.5,
    ...
    handletextpad = .01 ) # add legend to subplot (a)
