...
dPhis = np.arange( 0, 1, 0.01 ) # V; change in space charge potential
# dPhis = np.array([ 0.38 ]) # V; change in space charge potential
...
# fit_to_GC_result = {
GC_fit_result = {
    'ijs': [  # arrays len i and j, best dPhi and lambda indicies
        np.arange( 0, dPhi_n ), np.arange( 0, lambd_n ), best_i, best_j ],
...
pl.figure( figsize = ( 5, 4 ) ) # create a figure ( w, h )
