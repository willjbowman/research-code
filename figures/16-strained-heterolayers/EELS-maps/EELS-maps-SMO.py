...
leg_ents = [
    [ 'O K', 'F', 'Ce M5', 'Ce M4', 'Ce M45', 'Sm ?', 'Gd M45' ], 
    [ 'I Gd/Ce', 'I Ce_M4/M5', 'I Sm/Ce' ]
    ]
leg_loc = 'best'
...
for i, fname in enumerate( os.listdir( data_dir ) ):
    ...
    nm, iOK, iF, iCeM5, iCeM4, iCeM, iSm, iGdM = d
    ...
    ax1.plot( d[0], iSm/iCeM, marker=marks[0] )
