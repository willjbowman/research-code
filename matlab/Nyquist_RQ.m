...
R0 = 381; %ohm - system 'offset' resistance
R1 = 4.97e3; %ohm - R1 resistance
R2 = 9.54e3; %ohm - R2 resistance
%R3 = 5e2; %ohm - R3 resistance
Y1 = 8.69E-10; %F - C1 capacitance
Y2 = 1.35e-5; %F - C2 capacitance
...
%%%%%%%%%%%%%%
ZA = 1./(1/R1+Y1.*(1i.*w).^a1);
ZB = 1./(1/R2+Y2.*(1i.*w).^a2);
